...
class _InfiniteListViewState extends State<InfiniteListView> {
  ...
  List<Widget> _buildSlivers(BuildContext context, {bool negative = false}) {
    ...
    final padding = widget.padding ?? .zero;
    return <Widget>[
      SliverPadding(
        padding: negative
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<ScrollController>('controller', widget.controller, showName: false, defaultValue: null),
    );
...
class _InfiniteScrollPosition extends ScrollPositionWithSingleContext {
  ...
  @override
  double get minScrollExtent => .negativeInfinity;

  @override
  double get maxScrollExtent => .infinity;
}
